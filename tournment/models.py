...
class Tournment(models.Model):
	...
	name = models.CharField(max_length=100)
	tournment_type =  models.CharField(max_length=20, choices=TOURNAMENT_TYPES)
...
class TournmentMatch(models.Model):
	...
	def __str__(self):
		return f"Match of {self.tournment.name} on {self.date}"


class PlayerMatch(models.Model):
	tournment_match = models.ForeignKey(TournmentMatch, on_delete=models.CASCADE)
