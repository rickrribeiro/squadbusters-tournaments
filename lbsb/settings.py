"""
Django settings for lbsb project.
...
SECRET_KEY = "django-insecure-nv4^fj@dv%-)@5q+agc%#687$ep#an_+$m2+zu-q6!t%af2ze1"
...
WSGI_APPLICATION = "lbsb.wsgi.application"
